    ...
    <>
      <Card style={{ display: 'flex', width: '300px', height: 'auto' }}>
        <Card.Img
          className='hoverImg'
          variant='top'
          src={img ? `https://image.tmdb.org/t/p/original/${img}` : 'https://static.vecteezy.com/system/resources/previews/005/337/799/original/icon-image-not-found-free-vector.jpg'}
...
function FormFloatingBasicExample({searchMovie, movieList, movieTitle, selectMovie}) {
  ...
  return (
    <Row className="g-2">
      ...
      {movieList && movieList.results.slice(0, 7).map((movie, i) => (
        <div
          key={i}
